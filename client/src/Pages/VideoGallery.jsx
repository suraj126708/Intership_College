...
const VideoGallery = () => {
    ...
    useEffect(() => {
        const fetchVideos = async () => {
            try {
                const response = await axios.get('http://127.0.0.1:8080/api/videos/list');
    ...
    return (
        <div className="p-4 max-w-4xl mx-auto">
            ...
            {selectedVideo && (
                <div className="mb-4">
                    <AdvancedVideoPlayer 
                        src={`http://127.0.0.1:8080/uploads/videos/${selectedVideo.filename}`}
            ...
            <div className="grid grid-cols-3 gap-4">
                {videos.map((video, index) => (
                    ...
                    >
                        <video 
                            src={`http://127.0.0.1:8080/uploads/videos/${video.filename}`}
